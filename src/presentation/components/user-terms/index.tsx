  ...
  const embeds: embed[] = [
    {
      title: "1. Introdução",
      content:
        'Estes Termos de Uso ("Termos", "Contrato") estabelecem os termos e condições que regem o seu uso do site de vagas Dev’s Den. Ao usar o Site, você concorda em estar vinculado a estes Termos. Se você não concordar com estes Termos, você não deve usar o Site.\n' +
        "\n" +
        "Definições:",
      list: [
    ...
    },
    {
      ...
      content:
        "Para usar alguns dos recursos do Site, você pode precisar criar uma conta de usuário. Você é responsável por manter a confidencialidade de sua senha e por todas as atividades que ocorrem em sua conta. Você concorda em nos notificar imediatamente sobre qualquer uso não autorizado de sua conta.",
      list: [],
    },
    {
      title: "3. Uso do Site",
      content:
        "Você concorda em usar o Site apenas para fins lícitos e em conformidade com estes Termos. Você concorda em não usar o Site para:",
      list: [
    ...
    },
    {
      ...
      content:
        "O Site lista vagas de emprego de uma variedade de Empregadores. Não somos responsáveis ​​pela precisão ou veracidade das informações contidas nas vagas de emprego. Você concorda em usar seu próprio julgamento ao avaliar qualquer oportunidade de emprego.",
      list: [],
    },
    {
      title: "5. Inscrições em Vagas de Emprego",
      content:
        "Ao se candidatar a uma vaga de emprego, você concorda em fornecer informações precisas e completas. Você concorda em não se candidatar a qualquer vaga de emprego para a qual você não esteja qualificado.",
      list: [],
    },
    {
      title: "6. Direitos de Propriedade Intelectual",
      content:
        "Somos proprietários ou licenciados de todos os direitos de propriedade intelectual no Site e no seu Conteúdo. Você não pode usar o Site ou o seu Conteúdo sem nossa autorização prévia por escrito.",
      list: [],
    },
    {
      title: "7. Links para Terceiros",
      content:
        "O Site pode conter links para sites de terceiros. Não somos responsáveis ​​pelo conteúdo ou práticas de qualquer site de terceiros. Você concorda em acessar e usar sites de terceiros por sua própria conta e risco.",
      list: [],
    },
    {
      title: "8. Rescisão",
      content:
        "Podemos rescindir ou suspender sua conta e seu acesso ao Site a qualquer momento, sem aviso prévio, por qualquer motivo.",
      list: [],
    },
    {
