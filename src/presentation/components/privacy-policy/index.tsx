...
export default function PrivacePolicy() {
    const embeds: embed[] = [
        {
            title: "1. Introdução",
            content: "Esta Política de Privacidade (\"Política\") descreve como o site de vagas de TI Dev’s Den coleta, usa e divulga suas informações pessoais quando você usa o nosso site. Esta Política se aplica a todos os usuários do Site, incluindo candidatos a emprego, recrutadores e empregadores.",
            list: []
        },
        {
            title: "2. Coleta de informações pessoais",
            content: "Coletamos as seguintes informações pessoais quando você usa o nosso Site:",
            list: [
        ...
        },
        {
            ...
            content: "Podemos divulgar suas informações pessoais para as seguintes partes:",
            list: [
        ...
        },
        {
            ...
            content: "Você tem as seguintes opções em relação às suas informações pessoais:",
            list: [
        ...
        },
        {
            ...
            content: "Tomamos medidas de segurança razoáveis para proteger suas informações pessoais contra perda, uso indevido, divulgação não autorizada, acesso, alteração ou destruição. No entanto, nenhuma medida de segurança é perfeita e não podemos garantir que suas informações pessoais estejam completamente seguras.",
            list: []
        },
        {
            title: "7. Armazenamento de dados",
            content: "Armazenamos suas informações pessoais por um período de tempo necessário para cumprir os fins para os quais foram coletadas, a menos que seja exigido um período de retenção mais longo por lei.",
            list: []
        },
        {
