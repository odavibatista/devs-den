...
export default function CandidateRegister({
  ...
  const [registerCandidateData, setRegisterData] =
    useState<RegisterCandidateSchemaInterface>();
  ...
  const {
    ...
    formState: { errors },
    getValues,
  } = useForm<RegisterCandidateSchemaInterface>({
