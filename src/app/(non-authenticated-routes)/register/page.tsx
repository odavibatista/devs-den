...
export default function RegisterScreen() {
  ...
  const [registerType, setRegisterType] = useState<"candidate" | "company">(
    "candidate",
  );
    ...
    <main className={styles.main}>
      <section className={styles.form_section}>
        ...
        <div className={styles.controllers}>
          <span
            id={styles.candidate}
            className={`${styles.controller}  ${registerType === "candidate" ? styles.active : styles.unactive}`}
            onClick={() => registerTypeHandle("candidate")}
          >
            CANDIDATO
          </span>
          <span
            id={styles.company}
            className={`${styles.controller}  ${registerType === "company" ? styles.active : styles.unactive}`}
            onClick={() => registerTypeHandle("company")}
          >
            EMPRESA
          </span>
        </div>
