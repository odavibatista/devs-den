  ...
  return (
    <main className={styles.main}>
      <section className={styles.hero}>
        ...
        <h4 className={styles.hero_h4}>
          Empresas de todo o país buscam profissionais pelo DEV'S DEN.
        </h4>
      ...
      <section className={styles.categories_section}>
        <h1 className={styles.categories_h1}>
          <Emphasis text="ATUE" color="light_blue" /> NAS ÁREAS DE TI!
        </h1>
